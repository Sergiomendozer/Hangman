...
def is_word_guessed(wrong_guesses,chosen_word,partial_word, guess):
    check = chosen_word[0] + ' ' + chosen_word[1] + ' ' + chosen_word[2] +' ' + chosen_word[3] +' ' + chosen_word[4]
...
def hangman(wrong_guesses,chosen_word,partial_word, guess):
    if guess[0] == chosen_word[0] or guess[0].upper() == chosen_word[0] or guess[0] == chosen_word[0].upper():
    ...
    elif guess[0] == chosen_word[1]or guess[0].upper() == chosen_word[1]or guess[0] == chosen_word[1].upper():
        partial_word = partial_word.split()
        partial_word[1]= chosen_word[1]
        partial_word= ' '.join([str(element) for element in partial_word])
        return is_word_guessed(wrong_guesses,chosen_word,partial_word, guess)
    elif guess[0] == chosen_word[2]or guess[0].upper() == chosen_word[2]or guess[0] == chosen_word[2].upper():
        partial_word = partial_word.split()
        partial_word[2]= chosen_word[2]
        partial_word= ' '.join([str(element) for element in partial_word])
        return is_word_guessed(wrong_guesses,chosen_word,partial_word, guess)
    elif guess[0] == chosen_word[3]or guess[0].upper() == chosen_word[3]or guess[0] == chosen_word[3].upper():
        partial_word = partial_word.split()
        partial_word[3]= chosen_word[3]
        partial_word= ' '.join([str(element) for element in partial_word])
        return is_word_guessed(wrong_guesses,chosen_word,partial_word, guess)
    elif guess[0] == chosen_word[4]or guess[0].upper() == chosen_word[4]or guess[0] == chosen_word[4].upper():
        partial_word = partial_word.split()
        ...
        print ('\033[31m' + "Wrong Guesses: " + wrong_guesses + '\033[0m') 
        print ('\033[31m'+"The Letter " +guess+" is not in word, guess again:"+ '\033[0m')
        print (partial_word) 
        return (hangman(wrong_guesses,chosen_word,partial_word,input()))
